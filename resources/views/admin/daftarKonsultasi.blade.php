            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        $no = 1
                        @endphp
                		@foreach ($daftarKonsul as $konsul)
                        <tr>
                            <td>{{ $no++ }}</td>
							<td>{{ $konsul->name }}</td>
                            ...
                            <td> 
                                <a href="{{ url ('rangkuman/' .$konsul->id) }}"><i class="fas fa-edit" style="color: blue"></i></a>|<a href=""><i class="fas fa-trash-alt" style="color: red"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
