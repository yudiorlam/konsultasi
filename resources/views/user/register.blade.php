...
<head>
  ...
  <link rel="icon" type="image/png" sizes="16x16" href="{{asset('img/lutim.png')}}">
  ...
  style="background-image: url('{{asset('img/123.png')}}'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
        ...
        <div class="container">
          ...
          <div class="row mt-5">
            ...
            <div class="col-md-7 mb-5 mt-md-0 mt-5 white-text text-center text-md-left">
              ...
              <h6 class="mb-3 wow fadeInLeft" data-wow-delay="0.3s">Sebuah aplikasi untuk membantu untuk memberitahu
                secara anonim maupun tidak, disertai permintaan oleh pihak yang berkepentingan kepada pihak
    ...
    @endif
                    ...
                    <div class="md-form">
                      ...
                      @enderror
                      <label for="form3" class="active">NIP Anda..</label>
                    </div>
                    <div class="md-form">
