	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<script type="module">
			...
			const firebaseConfig = {
				apiKey: "AIzaSyAb1OCoAXegaaQitxpRJW_BFLr5FeS5g-U",
				authDomain: "konsultasi-online-ff291.firebaseapp.com",
				projectId: "konsultasi-online-ff291",
				storageBucket: "konsultasi-online-ff291.appspot.com",
				messagingSenderId: "754634939291",
				appId: "1:754634939291:web:197da93829017dabc81f3e",
				measurementId: "G-RGJ2P0PT22"
			};
			...
			messaging.getToken({vapidKey: "BNPytGmUs1YQFymqqGShBMHLT5qvSNL3bqv50TghxlcfKhmJKZWx1yMBjs0VMGvuAztN6vCK3RgmH4GCf_0ppBE"});
